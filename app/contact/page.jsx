...
const Contact = () => {
  ...
  const textareaStyle =
    "flex min-h-[80px] w-full rounded-md border-white/10 bg-primary px-4 py-5 text-base placeholder:text-white/60 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50";
  return (
    <motion.section
      initial={{ opacity: 0 }}
      animate={{
          ...
          <div className="xl:h-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                enter your informations and send me your request
              </p>
              {/* input */}
